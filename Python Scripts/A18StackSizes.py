...
"""
logging.basicConfig(level=logging.DEBUG, filename='A18StackSizes.log', filemode='w')
path = os.path.dirname(__file__)  # gets the absolute path to this file, minus the filename

filename = '/A18/items.xml'  # leading / is needed because the absolute path above doesn't include one at the end of the string
